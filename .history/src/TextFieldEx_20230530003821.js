  ...
  return (
    <Box mx={3}>
      ...
      <Stack spacing={2} direction={'row'} padding={'1rem'}>
        ...
        <TextField label='date' type='date' placeholder='Enter date' variant='filled' color='secondary' size='normal' mx={3}> </TextField>
        <TextField label='time' type='time' placeholder='Enter time' variant='standard' size='small' mx={3}> </TextField>
      </Stack>
