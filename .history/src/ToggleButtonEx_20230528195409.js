...
const ToggleButtonEx = () => {
  ...
  return (
    <>
      ...
      <Typography variant='body1' sx={getParaStyle} mx={'1rem'}>
      ...
      <ToggleButtonGroup sx={{mt: '1rem'}}>
        <ToggleButton> <FormatAlignLeftTwoToneIcon/> </ToggleButton>
        <ToggleButton> <FormatAlignCenterTwoToneIcon/> </ToggleButton>
        <ToggleButton> <FormatAlignJustifyTwoToneIcon/> </ToggleButton>
        <ToggleButton> <FormatAlignRightTwoToneIcon/> </ToggleButton>
      </ToggleButtonGroup>
