  ...
  return (
    <Box mx={3}>
      ...
      <Stack spacing={2} direction={'row'} padding={'1rem'}>
        ...
        <TextField label='Date' type='date' placeholder='Enter your first name' variant='filled' color='secondary' size='normal' mx={3}> </TextField>
        <TextField label='Time' type='time' placeholder='Enter first name' variant='standard' size='small' mx={3}> </TextField>
      </Stack>
