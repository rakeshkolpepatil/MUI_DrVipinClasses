...
const MuiTreeEx = () => {
  ...
  return (
    <Box>
      ...
      <Box width='80%'>
        <ShowTreeComponent activeNode={activeNode} selectedNode='Slider One'  > </ShowTreeComponent>
        <ShowTreeComponent activeNode={activeNode} selectedNode='Portal One'  > </ShowTreeComponent>
        <ShowTreeComponent activeNode={activeNode} selectedNode='Stepper One'  > </ShowTreeComponent>
        <ShowTreeComponent activeNode={activeNode} selectedNode='Modal One'  > </ShowTreeComponent>
      </Box>
    </Box>
  )
}
