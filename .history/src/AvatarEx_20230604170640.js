...
const AvatarEx = () => {
  return (
    <Box margin={2}>
      ...
      <Stack direction={'row'} spacing={2} mt={'2rem'} >
        <Avatar sx={{ width:50, height:50, bgcolor: deepOrange[400] }}> <Person2TwoToneIcon /> </Avatar>
        <Avatar sx={{ width:60, height:60, bgcolor: deepPurple[400] }}> <Person2TwoToneIcon/> </Avatar>
        <Avatar sx={{ width:70, height:70, bgcolor: red[300] }}> <Person2TwoToneIcon fontSize='large'/> </Avatar>
      </Stack>
