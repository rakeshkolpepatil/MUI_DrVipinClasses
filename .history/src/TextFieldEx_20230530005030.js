...
const TextFieldEx = () => {
  ...
  return (
    <Box mx={3}>
      ...
      <Stack spacing={2} direction={'row'} padding={'1rem'}>
        <TextField label='Password' onChange={e=>{setPass(e.target.value)}} required type='password' placeholder='Enter first name' variant='outlined' size='small' mx={3}> </TextField>
