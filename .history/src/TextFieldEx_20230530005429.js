...
const TextFieldEx = () => {
  ...
  return (
    <Box mx={3}>
      ...
      <Stack spacing={2} direction={'row'} padding={'1rem'}>
        <TextField label='Enter your salary' onChange={e=>{setPass(e.target.value)}} required type='password' placeholder='Enter first name' variant='outlined' size='small' mx={3}
        error={!pass}
        > </TextField>
        <TextField label='date' type='date' placeholder='Enter date' variant='filled' color='secondary' size='large' mx={3}> </TextField>
      </Stack>
