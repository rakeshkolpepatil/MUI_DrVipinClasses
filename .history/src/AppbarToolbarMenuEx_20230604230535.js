import { AppBar, Box, Button, IconButton, Toolbar, Typography, Menu } from '@mui/material'
...
const AppbarToolbarMenuEx = () => {
  ...
  return (
    ...
    >
      ...
      <Menu id="ratingMenu" anchorEl={ratingButton} keepMounted open={Boolean(ratingButton)} onClose={}>
