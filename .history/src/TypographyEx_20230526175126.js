...
const TypographyEx = () => {
  return (
    <div>
      ...
      <Typography variant='body2'> An example of 'body2' variant in typography. </Typography>
      <Typography variant='button' display='block'> I am example of 'button' variant in typography. </Typography>
      <Typography variant='caption' display='block'> Hey, Look at this example of 'caption' variant in typography. </Typography>
      <Typography variant='overline' > There is a 'overline' variant in typography. </Typography>
    </div>
  )
}

export default TypographyExc